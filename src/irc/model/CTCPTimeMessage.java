 ...
 *
 */
public class CTCPTimeMessage extends CTCPMessage {

	public CTCPTimeMessage(/*String message,*/ User user, String channel) {
		super("", user, channel);
		
	}

	public CTCPTimeMessage(String line) throws IllegalArgumentException {
	...
	private void digester(String line) throws IllegalArgumentException{
		if(line.startsWith(":") && line.contains("" +(char)(0x01))){
			...
			this.message = line.substring(line.indexOf(":" + (char)(0x01) + "TIME") + 6).trim();
		}
		else{
	...
	@Override
	public String apply(){
		return  "PRIVMSG " + this.channel + " :" + (char)(0x01) + "TIME" + (char)(0x01) +"\r\n";
		
	}
	
	public String answer(){
		return "NOTICE " + this.person.getNickName() + " :" + (char)(0x01) + "TIME " + LocalDateTime.now() + (char)(0x01) +"\r\n";
	}
