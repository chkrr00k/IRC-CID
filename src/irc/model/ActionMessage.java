 ...
 *
 */
public class ActionMessage extends CTCPMessage {

	public ActionMessage(String message, User user, String channel) {
		super(message, user, channel);
		
	}

	public ActionMessage(String line) throws IllegalArgumentException {
	...
	private void digester(String line) throws IllegalArgumentException{
		if(line.startsWith(":") && line.contains("" +(char)(0x01))){
			...
			this.message = line.substring(line.indexOf(" :" + (char)(0x01) + "ACTION ") + 9).trim();
		}
		else{
	...
	@Override
	public String apply(){
		return  "PRIVMSG " + this.channel + " :" + (char)(0x01) + "ACTION " + message + (char)(0x01) +"\r\n";
		
	}

	/* (non-Javadoc)
	 * @see irc.model.CTCPMessage#answer()
	 */
	@Override
